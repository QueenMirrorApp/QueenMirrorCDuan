...
//        String[] texts = value.item_ad_above_catelist_layout.split("@");
...
//            tempValue.item_ad_above_catelist_layout = texts[i];
...
//    }
    ...
    集合转字符串
     */
    public static String getStringText(List<String> list) {
        if (list == null) {
            return "";
        }
        String s = "";
